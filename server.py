...
def chat_server():
    ...
    print "sandesh server started on port " + str(PORT)
    ...
    while 1:
        ...
        for sock in ready_to_read:
            ...
            if sock == server_socket:
                ...
                broadcast(server_socket, sockfd, encrypt(key,"[%s:%s] entered our chatting \n" % addr))
